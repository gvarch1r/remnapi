...
debug_srr_matcher_response_dto_response_matched_rule_instance = DebugSrrMatcherResponseDtoResponseMatchedRule.from_json(json)
# print the JSON string representation of the object
print(DebugSrrMatcherResponseDtoResponseMatchedRule.to_json())

# convert the object into a dict
debug_srr_matcher_response_dto_response_matched_rule_dict = debug_srr_matcher_response_dto_response_matched_rule_instance.to_dict()
# create an instance of DebugSrrMatcherResponseDtoResponseMatchedRule from a dict
debug_srr_matcher_response_dto_response_matched_rule_from_dict = DebugSrrMatcherResponseDtoResponseMatchedRule.from_dict(debug_srr_matcher_response_dto_response_matched_rule_dict)
```
